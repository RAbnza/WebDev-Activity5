<?php
// edit.php?id=1 – edit an existing contact
...
<body class="bg-gray-50 min-h-screen flex flex-col items-center">
    <div class="w-full max-w-lg mt-12 bg-white rounded-xl shadow-lg p-8">
        <h1 class="text-2xl font-bold mb-6 text-gray-800">Edit Contact</h1>
        ...
        <form method="post" action="" class="space-y-5">
            ...
            <div>
                <input type="submit" value="Update Contact" class="w-full px-4 py-2 bg-yellow-500 text-white rounded font-semibold hover:bg-yellow-600 transition">
            </div>
        </form>
    </div>
</body>
